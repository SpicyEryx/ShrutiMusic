...
OWNER_ID = int(os.getenv("OWNER_ID", 8549583525))
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "SpicyEryx")
BOT_USERNAME = os.getenv("BOT_USERNAME", " ERYX_MUSIC_BOT")

MONGO_DB_URI = os.getenv("MONGO_DB_URI", None)
LOG_GROUP_ID = int(os.getenv("LOG_GROUP_ID", -1003800219305))
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/HEART_STR1NGS")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/HEART_STR1NGS")
INSTAGRAM = os.getenv("INSTAGRAM", "https://instagram.com/eryxbbyy")
YOUTUBE = os.getenv("YOUTUBE", "https://t.me/SpicyEryx")
GITHUB = os.getenv("GITHUB", "https://t.me/SpicyEryx")
DONATE = os.getenv("DONATE", "https://t.me/SpicyEryx")
PRIVACY_LINK = os.getenv("PRIVACY_LINK", "https://t.me/HEART_STR1NGS")
...
START_IMG_URL = os.getenv("START_IMG_URL", "https://files.catbox.moe/2kgzc2.jpg")
